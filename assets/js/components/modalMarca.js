                ...
                json_response.map((post)=>{    
                    if(post.images == false ){ 
                        ...
                        <div  class=" relative mt-4"> 
                            <div  class="pl-0 "> 
                                <img  class=" w-32 mb-10 sm:w-40 md:w-48 m-auto modal-logo "  src="${post.thumbnail}" alt="${post.title}">
                        ...
                        <div  class="grid grid-cols-1 sm:grid-cols-2 gap-8 sm:gap-10 relative">
                            ...
                            <a href="${post.link}" class="text-base text-title absolute bottom-0 left-0  -mb-7 hover:underline  "  >Compartir</a>
                        </div>
                            `; 
                    }
